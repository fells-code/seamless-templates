...
- e82c3b0: Add the `mobile` template kind and an Expo (React Native) starter, and let the API starters accept bearer sessions.
...
- d251699: The API starters connect to a managed database again when `DB_SSL_REJECT_UNAUTHORIZED=false`.
...
- 724a6cb: Move the API starters onto the adapters that forward the browser's user agent.
